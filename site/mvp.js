...
function loadMVP() {
  ...
  if (!data || Object.keys(data).length === 0) {
    fillCard("mvp1", { name: "NO DATA", team: "UPLOAD A LOG", kills: 0 });
    fillCard("mvp2", { name: "NO DATA", team: "UPLOAD A LOG", kills: 0 });
    fillCard("mvp3", { name: "NO DATA", team: "UPLOAD A LOG", kills: 0 });
    return;
  }
